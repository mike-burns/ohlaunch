// This is the ListActivity code but s/ListView/AbsListView/g.
// Google could have instead preferred composition, or just used the
// AbsListView themselves. It's not so hard, really.
/*
 ...
 * <p>
 * ListActivity hosts a {@link android.widget.AbsListView AbsListView} object that can
 ...
 * onCreate(). To do this, your own view MUST contain a AbsListView object with the
 ...
 * (the ListAdapter binds the AbsListView to the data; more on this later).
 * <p>
 ...
 * </p>
 * <p>
 * You bind the ListActivity's AbsListView object to data using a class that
 ...
 * to a two line row layout in the activity's AbsListView.
 * </p>
 *
 * <pre>
...
public class AbsListActivity extends Activity {
    ...
    public void onContentChanged() {
        ...
        mList = (AbsListView)findViewById(R.id.list);
        if (mList == null) {
